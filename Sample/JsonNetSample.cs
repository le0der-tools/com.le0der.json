...
public class JsonNetSample : MonoBehaviour
{
    ...
    void TestJson()
    {
        ...
        var c = JsonToolkit.DeserializeObject<CharacterListItem>(json);
    ...
    void SerailizeJson()
    {
        ...
        string json = JsonToolkit.SerializeObject(product);
        WriteLine(json);
    }
    ...
    void DeserializeJson()
    {
        ...
        Movie m = JsonToolkit.DeserializeObject<Movie>(json);
